    ...
    (function() {
            ...
            i: function() {
                ...
                this.initLanguage = this.oa = function(c, f, g) {
                    ...
                    if (-1 == b.indexOf(a)) {
                        b.push(a);
                        f && this.M(f, g);
                        for (var c = ktools.r.I(d), f = c.getElementsByTagName("data").length, g = h, j = 0; j < f; j++)
                            g = c.getElementsByTagName("data")[j].textContent != h ? c.getElementsByTagName("data")[j].textContent : h,
                            g == h && c.getElementsByTagName("data")[j].innerText && (g = c.getElementsByTagName("data")[j].innerText),
                            g == h && c.getElementsByTagName("data")[j].innerHTML && (g = c.getElementsByTagName("data")[j].innerHTML),
                            g == h && c.getElementsByTagName("data")[j].text && (g = c.getElementsByTagName("data")[j].text),
                            g == h && c.getElementsByTagName("data")[j].firstChild && (g = c.getElementsByTagName("data")[j].firstChild.data),
                            i.add(c.getElementsByTagName("data")[j].getAttribute("name"), g)
                    }
                }
                ;
        ...
        ktools.r.I = function(a) {
            ...
            try {
                ...
                b = document.implementation.createDocument("", "", l);
                b.onload = function() {
                    return b
                }
                ;
        ...
        ktools.e.fa = function(a) {
            for (var d = y = 0; a && !isNaN(a.offsetLeft) && !isNaN(a.offsetTop); )
        ...
        ;
        ktools.Color.hex2rgb = ktools.o.la;
        ktools.P = function() {
            function a(a) {
            ...
            this.isWP7 = this.Ca = function() {
                return -1 != navigator.userAgent.indexOf("Windows Phone 7")
            }
            ;
            ...
            this.isIOSRetina = this.ua = function() {
                return this.u() && 1 < window.devicePixelRatio
            }
            ;
            ...
            this.getInternetExplorerVersion = this.t = function() {
                ...
                if ("Microsoft Internet Explorer" == navigator.appName) {
                    ...
                    d.exec(b) != l ? a = parseFloat(RegExp.$1) : /Windows NT 10.*Edge\/([0-9]{1,}[.0-9]{0,})/.exec(b) != l && (a = parseFloat(RegExp.$1)));
                return a
            }
            ;
        ...
        ktools.R = function(a) {
            ...
            this.isFullscreen = this.D = function() {
                return "" === c ? document.fullscreen ? document.fullscreen : document.fullScreen : "webkit" == c ? document[c + "IsFullscreen"] ? document[c + "IsFullscreen"] : document[c + "IsFullScreen"] : document[c + "Fullscreen"] ? document[c + "Fullscreen"] : document[c + "FullScreen"]
            }
            ;
            ...
            this.getFullscreenEnabled = this.ca = function() {
                if (i)
                    return k;
                var a = document;
                return "" === c ? a.fullscreenEnabled ? a.fullscreenEnabled : a.fullScreenEnabled : "webkit" == c ? kolorBrowserDetect && "Safari" == kolorBrowserDetect.browser && 7 > kolorBrowserDetect.version ? m : a[c + "RequestFullscreen"] ? a[c + "RequestFullscreen"] : a[c + "RequestFullScreen"] : a[c + "FullscreenEnabled"] ? a[c + "FullscreenEnabled"] : a[c + "FullScreenEnabled"]
            }
            ;
            this.supportsFullscreen = this.Sa = function() {
                debug && console.log("ktools.Fullscreen.supportsFullscreen");
                f = "";
                if ("undefined" != typeof document.exitFullscreen || "undefined" != typeof document.exitFullScreen || "undefined" != typeof document.cancelFullscreen || "undefined" != typeof document.cancelFullScreen)
                    i = k,
                    f += "fullscreenchange";
                else
                    for (var a = 0, g = d.length; a < g; a++) {
                        c = d[a];
                        if ("undefined" != typeof document[c + "CancelFullScreen"] || "undefined" != typeof document[c + "CancelFullscreen"] || "undefined" != typeof document[c + "ExitFullscreen"] || "undefined" != typeof document[c + "ExitFullScreen"]) {
                ...
                "" != c && b.id && ("ms" == c ? (a += "#" + b.id + ":-" + c + "-fullscreen { height: 100% !important; width: 100% !important; max-height: 100% !important; background-color: black; }",
                a += "#" + b.id + ":-" + c + "-fullscreen::-" + c + "-backdrop { background-color: black; }") : a += "#" + b.id + ":-" + c + "-full-screen { height: 100% !important; width: 100% !important; max-height: 100% !important; background-color: black; }");
            ...
            this.request = this.La = function() {
                debug && console.log("ktools.Fullscreen.request");
                if (i) {
                    if (!this.D() || !this.p())
                        if ("" === c)
                            b.requestFullscreen ? b.requestFullscreen() : b.requestFullScreen();
                        else if (b[c + "RequestFullscreen"])
                            if ("webkit" == c)
                                b[c + "RequestFullscreen"](Element.O);
                            else
            ...
            this.exit = this.Y = function() {
                ...
                if (i) {
                    if (this.D() || this.p()) {
                        var a = document;
                        if ("" === c)
                            a.exitFullscreen ? a.exitFullscreen() : a.exitFullScreen ? a.exitFullScreen() : a.cancelFullscreen ? a.cancelFullscreen() : a.cancelFullScreen();
                        else if (a[c + "ExitFullscreen"])
                            a[c + "ExitFullscreen"]();
                        else if (a[c + "ExitFullScreen"])
                            a[c + "ExitFullScreen"]();
                        else if (a[c + "CancelFullscreen"])
                            a[c + "CancelFullscreen"]();
                        else
                            a[c + "CancelFullScreen"]()
                    }
                } else
                    this.b().exit && this.b().exit()
            }
        }
        ;
        ...
        ktools.k = function() {
            ...
            ;
            this.remove = this.remove = function(a) {
                if (this.map[a] != h)
                    return delete this.map[a],
                    --this.count
            }
            ;
        ...
        ktools.c = function() {
            ...
            this.loadScript = this.h = function(b, d, c) {
                if ("undefined" == typeof a.item(b)) {
                    ...
                    debug && console.log("DynamicLoader : " + b + " already loading/loaded"),
                    c && c()
            }
            ;
            this.loadCss = this.q = function(a, i) {
                ...
                if ("undefined" == typeof d.item(a)) {
                    ...
                    debug && console.log("css " + a + " already added")
            }
        }
        ;
        ...
        ktools.T = function(a, d, b, i) {
            ...
            ;
            this.addParentToCall = this.G = function(a) {
            ...
            this.loadScript = this.h = function(a) {
                ...
                if (c.F())
                    return c.s();
                if (0 == b.length)
                    ktools.c.d().h(c.getName(), c.l(), c.s);
                else
            ...
            this.callback = this.s = function() {
                ...
                c.N(k);
                for (var a = c.H(), b = l, d = a.keys(), g = 0; g < a.count; g++)
                    b = a.item(d[g]),
                    ktools.c.d().h(b.getName(), b.l(), b.s)
            }
        }
        ;
        ...
        ktools.S = function(a) {
            ...
            ;
            this.getEditorScript = this.ba = function() {
                return i
            }
            ;
